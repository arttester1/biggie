...
from verification import (
    ...
    verify_user_balance, track_rejection, is_group_blocked,
    ...
    REJECTED_GROUPS_PATH, CHAIN_MAP
)
...
# ---------------------------------------------
# Enhanced Periodic Verification with Debug Logging
# ---------------------------------------------
async def verify_all_members(bot, group_id: str, group_config: Dict[str, Any]):
    ...
    try:
        ...
        logger.info(f"Found {len(users)} users to verify in group {group_id}")
...
async def periodic_verification(context: CallbackContext):
